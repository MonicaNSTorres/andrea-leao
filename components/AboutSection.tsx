...
export function AboutSection() {
  return (
    <section id="sobre" className="bg-andrea-soft px-5 py-24">
      <div className="mx-auto grid max-w-7xl items-center gap-14 md:grid-cols-2">
        ...
        <Reveal delay={0.1}>
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-[#586d73]">
              O processo terapêutico busca fortalecer o autoconhecimento,
              ampliar a compreensão emocional e auxiliar na construção de
              caminhos mais leves e conscientes.
            </p>
