...
export function FinalCTA() {
  return (
    <section className="relative px-5 pt-16 pb-28 md:pt-24">
          ...
          <div className="relative">
            ...
            <Reveal delay={0.22}>
              <a
                href={whatsappUrl}
                target="_blank"
                className="mt-10 inline-flex items-center justify-center gap-2 rounded-full bg-white px-8 py-4 font-semibold text-[#4a7d8f] shadow-2xl transition hover:-translate-y-1 hover:scale-[1.02]"
              >
                Agendar consulta
                <ArrowRight size={18} />
              </a>
